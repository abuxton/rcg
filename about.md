...
share: true
---
<img src="{{ '/assets/images/rcg-fb-180x180.jpg' | relative_url }}" style='float:left' />Welcome to Red Circle Games, an independent effort to gather musings on Role Playing Games and Live Role Playing Games (RPG, LRP,LARP and L(A)RP). Regardless of the origin or inspiration.
...
!['When People unknowingly meet one day, Red Circle quote attributed wrongly to Buddha']({{ '/assets/images/rcg-header.jpg' | relative_url }})
